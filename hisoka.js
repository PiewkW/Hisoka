...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `Ciee yang Jadian💖 Jangan lupa Donasi Ke *Farel*🗿
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'Grub Farel',
                                    url: 'https://chat.whatsapp.com/Jgqy9E2QKFn5U3KQUWRPzN'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Farel',
                                    phoneNumber: '+6285172422723'
                                }
                            }, {
                                quickReplyButton: {
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                urlButton: {
                                    displayText: 'Grub Ofc FarelBotzMD',
...
⭔ Url : ${anu.url}`,
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) throw `Example : ${prefix + command} 6285172422723`
...
⭔ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                hisoka.sendListMsg(m.chat, `pilih aja *Farel* Setmenu nya!`, hisoka.user.name, `*Hello Farel* !`, `Pilih Farel`, sections, m)
                }
            }
            break
...
❏ *Info Creator*
> Name : *Flexxy*
> Nomor : *https://wa.me/6285172422723*
> Umur : *15*
> Region : *Indonesia*
> Hobyy : *Kepo*
> Made in : *Jambi*
> Nama Asli : *Farel Irwansyah*
└───────⭓
